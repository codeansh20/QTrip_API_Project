...
public class test_case_03 {
    ...
    public void TestCase03() throws InterruptedException {
        ...
        Assert.assertEquals(registerResStatusCode, 201,
                "Failed to validate that the user regsitration is successful");
        ...
        Assert.assertEquals(loginResStatusCode, 201,
                "Failed to validate that the user is logged in successfully");
        Assert.assertEquals(resBody.contains("token"), true,
                "Failed to validate that token is returned in login");
        Assert.assertEquals(resBody.contains("id"), true,
                "Failed to validate that userId is returned in login");
        Assert.assertEquals(resBody.contains("success"), true,
                "Failed to validate that login is successful");
        ...
        Assert.assertEquals(reservationResStatusCode, 200,
                "Failed to verfiy that the post reservation is successful");
